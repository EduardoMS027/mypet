...
public class PetVetService {
	...
	public PetVet fromDtoPetVet(PetVetDTO objDto) { // metado auxiliar que instacia uma categoria a partir de um DTO
		...
		return new PetVet(objDto.getId(), objDto.getNomeRazaoSocial(),null,null,objDto.getEmail(),objDto.getPassword(),0,objDto.getBairro(),objDto.getLogradouro(),objDto.getNumero(),objDto.getCep());
